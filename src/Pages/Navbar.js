            ...
            <div className="flex justify-start lg:w-0 lg:flex-1">
              ...
              >
                <span className="mx-auto text-xl font-black leading-none text-gray-900 select-none">
                  URLDB<span className="text-indigo-600">.</span>
                </span>
              </a>
            </div>
              ...
              <div className="flex flex-col items-center">
                {islogin ? (
                  ...
                  <>
                    <a
                      href="/signup"
                      className="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 max-w-96"
                    >
                      Sign up
                    </a>
